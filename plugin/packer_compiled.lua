...
_G.packer_plugins = {
  ...
  ["lspsaga.nvim"] = {
    ...
    loaded = true,
    path = "/home/os/.local/share/nvim/site/pack/packer/start/lspsaga.nvim",
  ...
  ["mason-lspconfig.nvim"] = {
    loaded = true,
    path = "/home/os/.local/share/nvim/site/pack/packer/start/mason-lspconfig.nvim",
    url = "git@github.com:williamboman/mason-lspconfig.nvim"
  },
  ["mason.nvim"] = {
    loaded = true,
    path = "/home/os/.local/share/nvim/site/pack/packer/start/mason.nvim",
  ...
  ["nvim-colorizer.lua"] = {
    loaded = true,
    path = "/home/os/.local/share/nvim/site/pack/packer/start/nvim-colorizer.lua",
  ...
  ["nvim-ts-autotag"] = {
    loaded = true,
    path = "/home/os/.local/share/nvim/site/pack/packer/start/nvim-ts-autotag",
